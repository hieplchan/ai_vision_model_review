...
class MatchPrior(object):
    """
    Match priors and ground-truth boxes to create targets of training dataset
    ...
    def __init__(self, center_form_priors, center_variance, size_variance, iou_threshold):
        ...
        self.corner_form_priors = utils.boxes.center_form_to_corner_form(center_form_priors)
